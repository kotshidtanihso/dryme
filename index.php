...
s1.async=true;
s1.src='https://embed.tawk.to/6a4c12cc539b7e1d4b7d4d6f/1jssiisnu';
s1.charset='UTF-8';
...
<body>
    <!-- Topbar Start -->
    <div class="container-fluid bg-primary py-3 d-none d-lg-block">
        <div class="container">
            <div class="row">
    ...
    <div class="container-fluid py-5">
        <div class="container" style="max-width: 900px;">
            <h6 class="text-secondary text-uppercase text-center font-weight-medium mb-3">Contact Us</h6>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <h4 class="text-center mb-4">Receive messages instantly with our PHP and Ajax contact form - available in the <a class="text-secondary" href="https://htmlcodex.com/downloading/?item=1198">Pro Version</a> only.</h4>
                    <form>
                        <div class="form-row">
